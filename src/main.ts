...
Thank you
*/
import { world, Player, system, MinecraftEffectTypes, MinecraftEntityTypes, MinecraftBlockTypes, Block, World, Entity } from "@minecraft/server"
...
import { Settings } from './types/worldsettings.js'
...
const settingsUI = (player: Player) => {
...
let all: Settings = Database('world-settings').getCollection()
